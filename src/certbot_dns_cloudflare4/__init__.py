"""
The `~certbot_dns_cloudflare.dns_cloudflare4` plugin automates the process of
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-cloudflare4 \\
     --dns-cloudflare4-credentials ~/.secrets/certbot/cloudflare.ini \\
     --dns-cloudflare4-propagation-seconds 60 \\
     -d example.com
